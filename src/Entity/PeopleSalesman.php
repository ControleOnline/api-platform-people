 ...
 * @ORM\Entity(repositoryClass="ControleOnline\Repository\PeopleSalesmanRepository")
...
class PeopleSalesman
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="ControleOnline\Entity\People", inversedBy="peopleSalesman")
     * @ORM\JoinColumns({
     ...
     * Set salesman
     *
     * @param \ControleOnline\Entity\People $salesman
     * @return PeopleSalesman
     */
