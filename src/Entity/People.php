...
class People extends Person
{
     ...
     * @var Collection
     *
     * @ORM\OneToMany(targetEntity="ControleOnline\Entity\PeopleFranchisee", mappedBy="franchisee")
     ...
     * @var Collection
     *
     * @ORM\OneToMany(targetEntity="ControleOnline\Entity\PeopleFranchisee", mappedBy="franchisor")
     ...
     * @return People
     */
    public function addDocument(\ControleOnline\Entity\Document $document)
    {
     ...
     * @return People
     */
    public function addPeopleEmployee(\ControleOnline\Entity\PeopleEmployee $peopleEmployee)
    {
     ...
     */
    public function removePeopleEmployee(\ControleOnline\Entity\PeopleEmployee $peopleEmployee)
    {
     ...
     * @return People
     */
    public function addPeopleCompany(\ControleOnline\Entity\PeopleEmployee $peopleCompany)
    {
     ...
     */
    public function removePeopleCompany(\ControleOnline\Entity\PeopleEmployee $peopleCompany)
    {
