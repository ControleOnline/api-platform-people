...
class People
{
    ...
    #[Groups(['people:read', 'people_link:read', 'people:write', 'order_details:read', 'contract:read', 'task:read'])]
    private $id;
    ...
    #[Groups(['people:read', 'people:write', 'order_details:read', 'contract:read', 'task:read'])]
    private $image;
