...
class PeopleFranchisee
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="ControleOnline\Entity\People", inversedBy="peopleFranchisor")
     * @ORM\JoinColumns({
     ...
     * @var \ControleOnline\Entity\People
     *
     * @ORM\ManyToOne(targetEntity="ControleOnline\Entity\People", inversedBy="peopleFranchisee")
     * @ORM\JoinColumns({
