---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/api-platform-people, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/api-platform-people`.
...
- Checkout local: `api-community/modules/controleonline/people`
